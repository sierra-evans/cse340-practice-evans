...
const courses = {
    ...
    'CSE340' : {
        ...
        description: 'This course equips students with the skills to plan, develop, and build dynamic, server-side rendered websites using a combination of backend and frontend technologies, databases, and industry-standard design patterns.',
        credits: 3,
        sections: [
            { time: '9:00 AM', room: 'STC 398', professor: 'Sister Woods' },
            { time: '12:00 PM', room: 'STC 396', professor: 'Sister Smith' },
            { time: '3:00 PM', room: 'STC 368', professor: 'Brother Daniels' }
        ]
    }
};
...
// Determines the acceptable pattern for course IDs
const courseIdPattern = /^[A-Z]{2,5}\d{3}$/;
...
app.get('/catalog/random', (req, res) => {
    ...
    res.redirect(`/catalog/${randomCourseId}`);
});
